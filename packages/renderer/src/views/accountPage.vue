<template>
  ...
  <div class="text-center">
    ...
    <h1>Connectivity</h1>
    <p>
      You are currently connected to {{ ipfsConnections?.length || 0 }} IPFS nodes, including {{ nOrbiterDevices }} user
      devices from {{ nOrbiterAccounts }} Orbiter accounts.
    </p>
  </div>
  <v-sheet v-if="debug" class="d-flex flex-column flex-sm-row ga-2 mx-auto mt-4 justify-center" color="transparent">
